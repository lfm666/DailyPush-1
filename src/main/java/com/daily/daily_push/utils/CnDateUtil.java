...
public class CnDateUtil {
    ...
    public static void main(String[] args) throws Exception {
        System.out.println(CnDateUtil.lunarToSolar("19980126", false));
        System.out.println(CnDateUtil.lunarToSolar("19990414", false));

        System.out.println("************");
        System.out.println(CnDateUtil.solarToLunar("1998-02-22", true));
        System.out.println(CnDateUtil.solarToLunar("1999-05-28", true));
    }
}
